...
const routes = [
    {
        ...
        routes: [
            { name: 'Route 1: Islamabad to Lahore', description: 'Islamabad to Lahore', buses: '10' },
            { name: 'Route 2: Lahore to Karachi', description: 'Lahore to Karachi', buses: '10' },
        ],
    },
    {
        category: 'Active Routes',
        routes: [
            { name: 'Route 1: Islamabad to Lahore', company: 'Daewoo', bus: 'Bus No 2' },
            { name: 'Route 2: Lahore to Karachi', company: 'Faisal Movers', bus: 'Bus No 2' },
        ],
    },
];
        ...
        <div className="p-6 bg-gray-50 min-h-screen w-full">
            ...
            {routes.map((section, index) => (
                <div key={index} className="mb-8">
                    {/* Section Heading */}
                    <h2 className="text-xl font-semibold text-gray-800 mb-4">{section.category}</h2>
                    ...
                    {section.routes.map((route, idx) => (
                        <div key={idx} className="flex justify-between items-center mb-4">
                            <div>
                                ...
                                {route.buses && (
                                    <p className="text-gray-600 text-sm">Number of buses: {route.buses}</p>
                                )}
                                {route.company && (
                                    <>
